...
import com.example.finalapplication.databinding.FragmentFoodBinding
        ...
        call?.enqueue(object : Callback<JsonResponse>{
            override fun onResponse( call: Call<JsonResponse>, response: Response<JsonResponse>) {
                if(response.isSuccessful){
                    ...
                    binding.jsonRecyclerView.adapter = JsonAdapter(requireContext(),response.body()?.body!!.items)
